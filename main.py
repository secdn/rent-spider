...
rooms_filepath = '/app/douban_rooms.json'
# rooms_filepath = 'C:/PythonWorkSpace/douban-room-spider-master/douban_rooms.json'


class DoubanRentSpider(object):
    default_headers = {
    ...
    search_url = 'https://www.douban.com/group/search'
...
def get_all_group_rooms():
    for group_id, group_name in groups:
        for location in locations:
            room_list = DoubanRentSpider().get_room_url_title_list(group_id, location)
